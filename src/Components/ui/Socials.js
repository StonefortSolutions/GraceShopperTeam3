...
function Socials({ product }) {
  const generateSocials = (product) => {
    return [
      {
        outlet: "Facebook",
        href: `https://www.facebook.com/sharer.php?u=https://stonefort.solutions/products/${product.id}`,
        background: "#3b5898",
      ...
      {
        outlet: "Twitter",
        href: `https://twitter.com/intent/tweet?url=https://stonefort.solutions/products/${product.id}`,
        background: "#00aced",
